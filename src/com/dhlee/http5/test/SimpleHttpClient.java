...
//		testGetCall ( "http://www.google.co.kr" );
		testConfigCall ( "http://www.google.co.kr" );
	}
	...
	public static void testConfigCall( String url ) throws Exception {
		System.out.println(">> Start  testConfigCall");
